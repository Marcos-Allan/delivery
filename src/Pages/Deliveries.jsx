  ...
  return (
    ...
    >
     ...
     <div
        ...
        className={`flex items-center justify-center w-[90%] bg-white h-20 px-3 py-2 rounded-xl border-2 border-[#a591ef] outline outline-white mb-4`}
    >
    ...
    >
     ...
     <div
        ...
        className={`flex items-center justify-center w-[90%] bg-[#a591ef] h-20 px-3 py-2 rounded-xl border-2 border-[#a591ef] outline outline-white mb-4`}
    >
